...
async function getPersonal_Empresa_Subdivisions(req,res){
  let [err,personal_empresa_subdivisions]=await get(models.Personal_Empresa_Subdivision.findAll({
    /* where:{estado: 'A'}, */
    include: [{all: true}]
  }))
...
async function getPersonal_Empresa_Subdivision(req,res){
  let [err,personal_empresa_subdivision]=await get(models.Personal_Empresa_Subdivision.findOne({
...
async function createPersonal_Empresa_Subdivision(req,res){
  let [err,personal_empresa_subdivision]=await get(models.Personal_Empresa_Subdivision.create({
...
async function updatePersonal_Empresa_Subdivision(req,res){
  let [err,personal_empresa_subdivision]=await get(models.Personal_Empresa_Subdivision.update({
