...
async function createLabor (req, res) {
  const [err, labor] = await get(models.Labor.create({
...
async function updateLabor (req, res) {
  const [err, labor] = await get(models.Labor.update({
